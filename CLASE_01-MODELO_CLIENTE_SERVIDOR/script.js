document.addEventListener('DOMContentLoaded', () => {
    ...
    if (currentId === 1 || currentId === totalSlides) {
        // En la primera y última, va dentro del panel de control
        btnHome.className = 'btn-home'; 
        navContainer.appendChild(btnHome);
    } else {
        // En las intermedias, va arriba a la izquierda de forma independiente
    ...
    if (questionsList) {
        const questions = [
            ...
            "En el gráfico de la Slide 03: ¿Qué sucede con el 'Main Thread' cuando una tarea se delega al 'Worker Pool'?",
